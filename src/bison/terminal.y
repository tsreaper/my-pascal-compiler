...
%token PAS_NIL PAS_NOT PAS_OF PAS_OR PAS_PACKED PAS_PROCEDURE PAS_PROGRAM PAS_RECORD PAS_REPEAT PAS_SET PAS_SIZEOF
...
%token SYM_SEMICOLON SYM_AT SYM_CARET SYM_LPAREN SYM_RPAREN SYM_NE SYM_LE SYM_GE SYM_ASSIGN SYM_RANGE
...
%type <tok> PAS_NIL PAS_NOT PAS_OF PAS_OR PAS_PACKED PAS_PROCEDURE PAS_PROGRAM PAS_RECORD PAS_REPEAT PAS_SET PAS_SIZEOF
...
%type <tok> SYM_SEMICOLON SYM_AT SYM_CARET SYM_LPAREN SYM_RPAREN SYM_NE SYM_LE SYM_GE SYM_ASSIGN SYM_RANGE

%type <tok> TYPE_INT TYPE_REAL TYPE_CHAR TYPE_BOOL TYPE_STRING
