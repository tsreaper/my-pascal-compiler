...
%token PAS_AND PAS_ARRAY PAS_BEGIN PAS_BREAK PAS_CASE PAS_CONST PAS_CONTINUE PAS_DIV PAS_DO PAS_DOWNTO
%token PAS_ELSE PAS_END PAS_FILE PAS_FOR PAS_FORWARD PAS_FUNCTION PAS_GOTO PAS_IF PAS_IN PAS_LABEL PAS_MOD
...
%type <tok> PAS_AND PAS_ARRAY PAS_BEGIN PAS_BREAK PAS_CASE PAS_CONST PAS_CONTINUE PAS_DIV PAS_DO PAS_DOWNTO
%type <tok> PAS_ELSE PAS_END PAS_FILE PAS_FOR PAS_FORWARD PAS_FUNCTION PAS_GOTO PAS_IF PAS_IN PAS_LABEL PAS_MOD
