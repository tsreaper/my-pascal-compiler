...
%token PAS_FILE PAS_FOR PAS_FORWARD PAS_FUNCTION PAS_GOTO PAS_IF PAS_IN PAS_LABEL PAS_MOD PAS_NIL PAS_NOT
%token PAS_OF PAS_OR PAS_PACKED PAS_PROCEDURE PAS_PROGRAM PAS_RECORD PAS_REPEAT PAS_SET PAS_THEN PAS_TO PAS_TYPE
%token PAS_UNTIL PAS_VAR PAS_WHILE PAS_WITH PAS_XOR
...
%type <tok> PAS_FILE PAS_FORWARD PAS_FOR PAS_FUNCTION PAS_GOTO PAS_IF PAS_IN PAS_LABEL PAS_MOD PAS_NIL PAS_NOT
%type <tok> PAS_OF PAS_OR PAS_PACKED PAS_PROCEDURE PAS_PROGRAM PAS_RECORD PAS_REPEAT PAS_SET PAS_THEN PAS_TO PAS_TYPE
%type <tok> PAS_UNTIL PAS_VAR PAS_WHILE PAS_WITH PAS_XOR
